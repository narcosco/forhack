$(document).ready(function(){
    ...
    $('.rp-select').click(function(){
        if($('.rate-area').hasClass('area-disabled')) {
                    ...
                    $.magnificPopup.open({
                        ...
                        callbacks: {
                            ...
                            close: function() {
                                ...
                                $('.rate-area').removeClass('area-disabled');
...
$('.rate-button').click(function(){
        if($('.rate-area').hasClass('area-disabled') || $account_connected == false) {
            sweetAlert("Error", "Please connect your account.", "error");
        } else {
            if($selected_rp != ''){
                ...
                sweetAlert("Error", "Please Like The Video & leave a comment.", "error");
            }
        }
    });
    ...
    $('.gen-button').click(function(){
        if($('.gen-area').hasClass('area-disabled') || $account_connected == false) {
            ...
            if($selected_rp != ''){
                ...
                sweetAlert("Error", "Please select an amount of coins to generate.", "error");
            }
        }
    });
